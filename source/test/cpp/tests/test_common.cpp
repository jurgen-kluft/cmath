...
test_rand_mat4(mat4 dest) {
  ...
  /* random position */
  dest[3][0] = glm_frand48();
  dest[3][1] = glm_frand48();
  dest[3][2] = glm_frand48();

  /* random rotatation around random axis with random angle */
  glm_rotate(dest, glm_frand48(), (vec3){glm_frand48(), glm_frand48(), glm_frand48()});

  /* random scale */
  /* glm_scale(dest, (vec3){glm_frand48(), glm_frand48(), glm_frand48()}); */
}

void
test_rand_mat4x2(mat4x2 dest) {
  dest[0][0] = glm_frand48();
  dest[0][1] = glm_frand48();

  dest[1][0] = glm_frand48();
  dest[1][1] = glm_frand48();

  dest[2][0] = glm_frand48();
  dest[2][1] = glm_frand48();
...
test_rand_mat4x3(mat4x3 dest) {
  dest[0][0] = glm_frand48();
  dest[0][1] = glm_frand48();
  dest[0][2] = glm_frand48();

  dest[1][0] = glm_frand48();
  dest[1][1] = glm_frand48();
  dest[1][2] = glm_frand48();

  dest[2][0] = glm_frand48();
  dest[2][1] = glm_frand48();
  dest[2][2] = glm_frand48();
...
test_rand_mat3(mat3 dest) {
  ...
  /* random rotatation around random axis with random angle */
  glm_rotate_make(m4, glm_frand48(), (vec3){glm_frand48(), glm_frand48(), glm_frand48()});
...
test_rand_mat3x4(mat3x4 dest) {
  ...
  dest[0][1] = glm_frand48();
  dest[0][2] = glm_frand48();
  dest[0][3] = glm_frand48();

  dest[1][0] = glm_frand48();
  dest[1][1] = glm_frand48();
  dest[1][2] = glm_frand48();
  dest[1][3] = glm_frand48();

  dest[2][0] = glm_frand48();
  dest[2][1] = glm_frand48();
  dest[2][2] = glm_frand48();
  dest[2][3] = glm_frand48();
}
...
test_rand_quat(versor q) {
  glm_quat(q, glm_frand48(), glm_frand48(), glm_frand48(), glm_frand48());
