...
#define TEST_IMPL_CHOOSER(...) EXPAND(TEST_IMPL_ARG3(__VA_ARGS__, TEST_IMPL_ARG2, TEST_IMPL_ARG1))
...
#define ASSERT_EXT(expr, msg)                                                                                                                                                      \
    if (!(expr))                                                                                                                                                                   \
    {                                                                                                                                                                              \
        fprintf(stderr, RED "  assert fail" RESET " in " BOLDCYAN "%s " RESET "on " BOLDMAGENTA "line %d" RESET " : " BOLDWHITE " ASSERT(%s)\n" RESET, __FILE__, __LINE__, #expr); \
...
#define ASSERTIFY(expr)                                                                                                                                                                   \
    ...
    {                                                                                                                                                                                     \
        ...
        {                                                                                                                                                                                 \
            fprintf(stderr, RED "  assert fail" RESET " in " BOLDCYAN "%s " RESET "on " BOLDMAGENTA "line %d" RESET " : " BOLDWHITE " ASSERTIFY(%s)\n" RESET, __FILE__, __LINE__, #expr); \
