...
#include "cmath/struct/vec3-ext.h"
 ...
 */
CGLM_INLINE
float glms_vec3_distance(vec3s a, vec3s b) { return glm_vec3_distance(a.raw, b.raw); }
 ...
 */
CGLM_INLINE
float glms_vec3_distance2(vec3s a, vec3s b) { return glm_vec3_distance2(a.raw, b.raw); }
