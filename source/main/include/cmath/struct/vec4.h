...
#include "cmath/struct/vec4-ext.h"
 ...
 */
CGLM_INLINE
float glms_vec4_distance(vec4s a, vec4s b) { return glm_vec4_distance(a.raw, b.raw); }
 ...
 */
CGLM_INLINE
float glms_vec4_distance2(vec4s a, vec4s b) { return glm_vec4_distance2(a.raw, b.raw); }
