...
#include "cmath/struct/vec2-ext.h"
 ...
 */
CGLM_INLINE
float glms_vec2_distance(vec2s a, vec2s b) { return glm_vec2_distance(a.raw, b.raw); }
 ...
 */
CGLM_INLINE
float glms_vec2_distance2(vec2s a, vec2s b) { return glm_vec2_distance2(a.raw, b.raw); }
