...
float glm_mat4_det_neon(mat4 mat)
{
    ...
    /*
     ...
     t[4] = i * o - m * k;
     */
    x0 = glmm_fnmadd(vcombine_f32(kl, kl), vcombine_f32(nn, mm), vmulq_f32(vcombine_f32(op, op), vcombine_f32(jj, ii)));
    ...
    /*
     ...
     t[5] = i * n - m * j;
     */
    x1 = glmm_fnmadd(vcombine_f32(vdup_lane_f32(kl, 0), jj), vcombine_f32(vdup_lane_f32(op, 1), mm), vmulq_f32(vcombine_f32(vdup_lane_f32(op, 0), nn), vcombine_f32(vdup_lane_f32(kl, 1), ii)));
    ...
    /*
     ...
     - d * (e * t[2] - f * t[4] + g * t[5])
     */
    x2 = glmm_fnmadd(vcombine_f32(vdup_lane_f32(gh, 1), vdup_lane_f32(ef, 0)), vcombine_f32(vget_low_f32(a1.val[0]), t34), vmulq_f32(vcombine_f32(ef, vdup_lane_f32(ef, 1)), vcombine_f32(vget_low_f32(x1), t12)));

    x2 = glmm_fmadd(vcombine_f32(vdup_lane_f32(gh, 0), gh), vcombine_f32(vget_low_f32(a1.val[1]), vget_high_f32(x1)), x2);
...
{
    float32x4_t   r0, r1, r2, r3, v0, v1, v2, v3, t0, t1, t2, t3, t4, t5, x0, x1, x2, x3, x4, x5, x6, x7, x8;
    float32x4x2_t a1;
    ...
    /* determinant */
    x0 = vcombine_f32(vget_low_f32(vzipq_f32(v0, v1).val[0]), vget_low_f32(vzipq_f32(v2, v3).val[0]));
