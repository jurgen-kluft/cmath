 ...
 */
CGLM_INLINE
void glm_vec4_lerpc(vec4 from, vec4 to, float t, vec4 dest) { glm_vec4_lerp(from, to, glm_clamp_zo(t), dest); }
 ...
 */
CGLM_INLINE
void glm_vec4_mix(vec4 from, vec4 to, float t, vec4 dest) { glm_vec4_lerp(from, to, t, dest); }
 ...
 */
CGLM_INLINE
void glm_vec4_mixc(vec4 from, vec4 to, float t, vec4 dest) { glm_vec4_lerpc(from, to, t, dest); }
 ...
 */
CGLM_INLINE
void glm_vec4_smoothinterpc(vec4 from, vec4 to, float t, vec4 dest) { glm_vec4_smoothinterp(from, to, glm_clamp_zo(t), dest); }
