 ...
 */
CGLM_INLINE
bool glm_vec2_eq_eps(vec2 v, float val) { return fabsf(v[0] - val) <= GLM_FLT_EPSILON && fabsf(v[1] - val) <= GLM_FLT_EPSILON; }
 ...
 */
CGLM_INLINE
bool glm_vec2_eqv_eps(vec2 a, vec2 b) { return fabsf(a[0] - b[0]) <= GLM_FLT_EPSILON && fabsf(a[1] - b[1]) <= GLM_FLT_EPSILON; }
 ...
 */
CGLM_INLINE
bool glm_vec2_isvalid(vec2 v) { return !glm_vec2_isnan(v) && !glm_vec2_isinf(v); }
