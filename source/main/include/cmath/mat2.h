...
#ifdef CGLM_SSE_FP
#    include "cmath/simd/sse2/mat2.h"
#endif

#ifdef CGLM_NEON_FP
#    include "cmath/simd/neon/mat2.h"
#endif
...
#else
    float a00 = m1[0][0], a01 = m1[0][1], a10 = m1[1][0], a11 = m1[1][1], b00 = m2[0][0], b01 = m2[0][1], b10 = m2[1][0], b11 = m2[1][1];
 ...
 */
CGLM_INLINE
float glm_mat2_det(mat2 mat) { return mat[0][0] * mat[1][1] - mat[1][0] * mat[0][1]; }
